...
function M.exec(opt, cacheFile)
   if opt.data then
      print("=> Generatiung list of images")
      print(" | finding all training images")
      local trainData = convertToTensor({
         paths.concat(opt.data, 'data_batch_1.t7'),
         paths.concat(opt.data, 'data_batch_2.t7'),
         paths.concat(opt.data, 'data_batch_3.t7'),
         paths.concat(opt.data, 'data_batch_4.t7'),
         paths.concat(opt.data, 'data_batch_5.t7'),
      })
      print(" | finding all validation images")
      local testData = convertToTensor({
         paths.concat(opt.data, 'test_batch.t7')
      })
